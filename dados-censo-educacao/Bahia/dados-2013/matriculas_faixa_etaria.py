...
class MatriculasFaixaEtariaBahia:
    ...
    def get_total_matriculas_faixa_etaria_porcentagem(self):
        ...
        for c in matriculas_faixa_etaria['Estadual']:
            total_matriculas_faixa_etaria_porcentagem['Estadual'][c] = round(
        ...
        for c in matriculas_faixa_etaria['Municipal']:
            total_matriculas_faixa_etaria_porcentagem['Municipal'][c] = round(
        ...
        for c in total_matriculas_faixa_etaria_porcentagem['Estadual']:
            total_matriculas_faixa_etaria_porcentagem['Estadual'][c] = str(
                total_matriculas_faixa_etaria_porcentagem['Estadual'][c]) + '%'

        for c in total_matriculas_faixa_etaria_porcentagem['Municipal']:
            total_matriculas_faixa_etaria_porcentagem['Municipal'][c] = str(
                total_matriculas_faixa_etaria_porcentagem['Municipal'][c]) + '%'

        for c in total_matriculas_faixa_etaria_porcentagem['Privada']:
            total_matriculas_faixa_etaria_porcentagem['Privada'][c] = str(
                total_matriculas_faixa_etaria_porcentagem['Privada'][c]) + '%'

        for c in total_matriculas_faixa_etaria_porcentagem['Federal']:
            total_matriculas_faixa_etaria_porcentagem['Federal'][c] = str(
                total_matriculas_faixa_etaria_porcentagem['Federal'][c]) + '%'
    ...
    def get_total_matriculas_faixa_etaria_geral_porcentagem(self):
        ...
        for c in total_matriculas_faixa_etaria_geral:
            total_matriculas_faixa_etaria_geral_porcentagem[c] = round(
                total_matriculas_faixa_etaria_geral[c] / sum(total_matriculas_faixa_etaria_geral.values()) * 100, 2)

        # adiciona símbolo de porcentagem
        for c in total_matriculas_faixa_etaria_geral_porcentagem:
            total_matriculas_faixa_etaria_geral_porcentagem[c] = str(
                total_matriculas_faixa_etaria_geral_porcentagem[c]) + '%'
