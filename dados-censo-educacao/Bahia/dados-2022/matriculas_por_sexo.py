...
class MatriculasPorSexoBahia:
        ...
        for sexo in matriculas_por_sexo:
            for categoria in matriculas_por_sexo[sexo]:
                if categoria == 'Estadual':
                    matriculas_por_sexo_por_dependencia_administrativa['Estadual'][sexo] += round(matriculas_por_sexo[sexo][
                        categoria], 2)
                elif categoria == 'Municipal':
                    matriculas_por_sexo_por_dependencia_administrativa['Municipal'][sexo] += round(matriculas_por_sexo[sexo][
                        categoria], 2)
                elif categoria == 'Privada':
                    matriculas_por_sexo_por_dependencia_administrativa['Privada'][sexo] += round(matriculas_por_sexo[sexo][
                        categoria], 2)
                elif categoria == 'Federal':
                    matriculas_por_sexo_por_dependencia_administrativa['Federal'][sexo] += round(matriculas_por_sexo[sexo][
                        categoria], 2)
    ...
    def get_percentual_por_sexo_dependencia_administrativa(self):
        ...
        for categoria in matriculas_por_sexo_por_dependencia_administrativa:
            ...
            total = matriculas_por_sexo_por_dependencia_administrativa[categoria]['Feminino'] + \
                    matriculas_por_sexo_por_dependencia_administrativa[categoria]['Masculino']
            # calcula o total de matriculas feminino, divide pelo total de matriculas e multiplica por 100
            percentual_por_sexo_dependencia_administrativa[categoria]['Feminino'] = round(
                (matriculas_por_sexo_por_dependencia_administrativa[categoria]['Feminino'] / total) * 100, 2)
            # calcula o total de matriculas masculino, divide pelo total de matriculas e multiplica por 100
            percentual_por_sexo_dependencia_administrativa[categoria]['Masculino'] = round(
                (matriculas_por_sexo_por_dependencia_administrativa[categoria]['Masculino'] / total) * 100, 2)
            # adiciona os valores em percentual_por_sexo_dependencia_administrativa
            percentual_por_sexo_dependencia_administrativa[categoria]['Feminino'] = str(
                percentual_por_sexo_dependencia_administrativa[categoria]['Feminino']) + '%'
            percentual_por_sexo_dependencia_administrativa[categoria]['Masculino'] = str(
                percentual_por_sexo_dependencia_administrativa[categoria]['Masculino']) + '%'
