...
class LeitorDeDados:
    ...
    def get_dados_faixa_etaria_csv(self):
        ...
        df_faixa_etaria = pd.read_csv(url + '/dados-2018/matriculas-faixa_etaria-salvador.csv', sep=';')

        return df_faixa_etaria
    
    def get_dados_raca_cor_csv(self):
            
        df_raca_cor = pd.read_csv(url + '/dados-2018/matriculas-cor_raca-salvador.csv', sep=';')
