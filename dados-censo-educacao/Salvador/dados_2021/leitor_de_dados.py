...
class LeitorDeDados:
    ...
    def get_dados_faixa_etaria_csv(self):
        ...
        df_faixa_etaria = pd.read_csv(url + '/dados-2021/matriculas-faixa_etaria-salvador.csv', sep=';')
    ...
    def get_dados_sexo_csv(self):
        ...
        df_sexo = pd.read_csv(url + '/dados-2021/matriculas-sexo-salvador.csv', sep=';')
