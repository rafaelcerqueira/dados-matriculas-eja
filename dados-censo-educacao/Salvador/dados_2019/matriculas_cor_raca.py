...
class MatriculasSalvadorCorRaca:
    ...
    def get_porcentagem_matriculas_dependencia_administrativa(self):
        ...
        #percorre get_matriculas_dependencia_administrativa() e calcula a porcentagem de cada raça/cor em cada dependência administrativa
        for dependencia_administrativa in matriculas_dependencia_administrativa:
            for raca_cor in matriculas_dependencia_administrativa[dependencia_administrativa]:
                porcentagem_matriculas_dependencia_administrativa[dependencia_administrativa][raca_cor] = round((matriculas_dependencia_administrativa[dependencia_administrativa][raca_cor] / sum(matriculas_dependencia_administrativa[dependencia_administrativa].values())) * 100, 2)
        ...
        for dependencia_administrativa in porcentagem_matriculas_dependencia_administrativa:
            for raca_cor in porcentagem_matriculas_dependencia_administrativa[dependencia_administrativa]:
                porcentagem_matriculas_dependencia_administrativa[dependencia_administrativa][raca_cor] = str(porcentagem_matriculas_dependencia_administrativa[dependencia_administrativa][raca_cor]) + '%'
...
matricula = MatriculasSalvadorCorRaca(df)

print(matricula.get_matriculas_raca_porcentagem_total())
