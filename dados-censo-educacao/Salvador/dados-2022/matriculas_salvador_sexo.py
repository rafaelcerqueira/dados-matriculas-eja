...
class MatriculasSalvadorSexo:
    ...
    #a função retorna um dicionário  com a quantidade de matrículas do sexo masculino e feminino por dependência administrativa.
    def get_matriculas_por_sexo(self):
        ...
        #loop que percorre o dataframe e adiciona os valores as chaves em cada dicionário equivalente.
        ...
        #retorna um dicionário com dois dicionários aninhados.
        return {'Feminino': matriculas_feminino, 'Masculino': matriculas_masculino}
    
    #total de matrículas de cada sexo por dependência administrativa.
